...
Jeweils ein Eckzylinder wird anschließend an den Start- bzw. Endknoten des Quaders verschoben, sodass zwischen diesem und den beiden \q{CornerCylinder} eine Differenzmenge gebildet werden kann.
