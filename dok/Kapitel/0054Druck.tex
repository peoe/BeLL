...
Für die Größenberechnung der Eckpfeiler wird der längste Eckpin festgestellt, welcher an dem jeweiligen Objekt anliegt.
...
Bei diesem Algorithmus wird zuerst der Punkt mit der kleinsten Ordinate als Startpunkt $P_0$ festgegelegt.
