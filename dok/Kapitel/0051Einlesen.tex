...
Die GUI setzt sich zusammen aus einem \icode{JFrame}, indem ein \icode{JTextField}, ein \icode{FileChooserButton}, ein \icode{StartButton} und ein \icode{ShowResultButton} platziert sind.
...
Nachdem der Nutzer eine existente Datei ausgewählt hat, wird nun der \icode{StartButton} aktiviert und er kann den Konvertierungsprozess starten.
...
\todoinline{Bild der finalen GUI einfügen}