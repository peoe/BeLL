...
Diese können dann ausgehend von einem zweidimensionalen Polygon in Prismen umgewandelt werden (\icode{linear\_extrude()}), welche vor allem das Umwandeln von komplexen Formen in Objekte erleichtert. \\
