...
Basierend auf der Kanten- und Knotenliste werden alle folgenden Kalkulationen der \icode{Graph}-Klasse durchgeführt.
...
\begin{code}[Zuweisung der Beziehungen im Programm]
...
In der Anwendung wird die Gaußsche Trapezformel verwendet, welche bei einem umgekehrten Drehsinn einen negativen Flächeninhalt ausgibt und das äußere Gebiet erkennbar macht.
